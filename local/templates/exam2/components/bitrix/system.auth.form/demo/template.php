...
<nav class="menu-block">
	<ul>
		<li class="att popup-wrap">
			<a id="hd_singin_but_open" href="" class="btn-toggle"><?=GetMessage("AUTH_LOGIN_LINK_TEXT")?>
			</a>
...
<?endif?>
		...
		<li>
		<a href="<?=$arResult["AUTH_REGISTER_URL"]?>"><?=GetMessage("AUTH_REGISTER")?>
		</a>
		</li>
	</ul>
</nav>
<?else:?>
<pre><?print_r($arReslut)?></pre>
<nav class="menu-block">
      <ul>
          <li>
